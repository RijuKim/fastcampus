package fastcampus.part1.voca_list
...
import fastcampus.part1.voca_list.databinding.ActivityAddBinding
import fastcampus.part1.voca_list.databinding.ItemWordBinding
    ...
    private fun edit() {
        ...
        Thread {
            editword?.let { word ->
                ...
                setResult(RESULT_OK, intent)
                runOnUiThread { Toast.makeText(this, "수정을 완료습니다.", Toast.LENGTH_SHORT).show() }
                finish()
            }
        }.start()
    }
